package com.example.k5_iot_springboot.dto.E_Board.response;
...
public class BoardResponseDto {
    ...
    */
    public record DetailResponse(
        ...
        public static DetailResponse from(E_Board board) {
    ...
    */
    public record SummaryResponse(
        ...
        public static SummaryResponse from(E_Board board) {
...
//    === 페이지 정보 메타 === //
    ...
    public record PageMeta(
        ...
        public static PageMeta from(Page<?> p) {
            String sort = p.getSort().toString(); // ex) createAt: DESC
