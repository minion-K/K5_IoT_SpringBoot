...
/*
    ...
    : 요청이 어떤 목적을 가지고 있는지 명시하는 방법
        ...
        1) GET(가져오기) - 서버로부터 데이터를 가져올 것을 요청
        ...
        EX) BoardController (게시판에 대한 요청을 "처리"하는 Controller 클래스)
            ...
            [GET] /boards/id=? : 해당 ID의 게시글 조회
            [PUT] /boards/id=? : 해당 ID의 게시글 수정
            [DELETE]/ boards/id=? : 해당 ID의 게시글 삭제
        ...
        : 요청에 대한 처리 결과를 숫자와 간단한 메시지로 알려줌
            ...
            2) 400 - 개발자가 처리해야 하는 문제
                ...
                404 NOT FOUND: 요청 자체를 찾을 수 없음 (해당하는 요청이 없음)
