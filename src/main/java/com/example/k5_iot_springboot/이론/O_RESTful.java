...
/*
    ...
    3. RESTful API Best practice
        ...
        3) 언더바 X, 하이픈 O - 단어의 구분은 하이픈으로 연결
        ...
        5) 계층 구조 표현: 관계는 / 로 표현
            (O) - /users/{userId}/orders/{orderId} - 특정사용자(userId)의 주문들 중 특정 주문(orderId)
        ...
        case2) 쇼핑몰
            ...
            - 상품 리뷰 조회: GET /api/v1/products/{productsId}/reviews
            - 장바구니: GET /api/v1/users/me/cart (사용자 1인당 장바구니 1개)
