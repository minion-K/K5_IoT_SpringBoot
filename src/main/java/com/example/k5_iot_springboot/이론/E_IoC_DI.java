...
/*
    ...
    >> 생성자 주입 방식(권장), 필드(Field) 주입 방식, 세터 주입(Setter) 방식
*/
...
//        >> Book1이 변경되면 BookStore1도 같이 수정(결합도가 높음)
//          : 확장성, 유지보수성, 테스트에 어려움
        this.book = new Book1("SpringBoot 기초");
    }
...
//    스프핑이 Book2 객체를 생성하여 자동으로 BookStore2에 넣어줌 (매개변수로 전달)
...
// - 네이밍 규칙
//      > 클래스명의 첫 클자를 소문자로 바꾼 이름이 기본 Bean의 이름
