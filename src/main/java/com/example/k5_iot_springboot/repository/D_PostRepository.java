...
//
//    === 2. JPQL(@Query) ===
//    : 그룹핑/집계/조인/서브쿼리 등 쿼리 메서드로 표현이 어려운 경우 명시적으로 JPQL을 작성
...
//    == 댓글이 가장 많은 상위 N개 (JPQL & Native SQL) == //
    @Query("""
...
//    특정 작성자의 게시글 중, 댓글 수가 minCount 이상인 게시글 조회
    @Query(value = """
        ...
        having p.author = :author AND count(c.id) = :minCount
